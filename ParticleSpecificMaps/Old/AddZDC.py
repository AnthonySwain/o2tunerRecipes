'''
Fine tuning a set of cylinders i.e give their Z extents and inner radii and this will try to optimise further radii only.
This specific version only looks to optimise the part of the detector that was not optimised when the ZDC was not included in simulations
