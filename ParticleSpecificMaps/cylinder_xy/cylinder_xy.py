'''
Optimisation for a single cylinder, Zmin/max and Rmax should be defined in the yaml file to
help speed-up the process of finding the desired cylinder. 

Z extent and radius is define which is passed to macro which creates a cylindrical voxel-map which 
is then used in the stepping part of the simulation to decide where to stop particles transport.
'''
